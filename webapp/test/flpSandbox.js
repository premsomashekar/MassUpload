		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mass Upload",
									"targetURL": "#ainmassupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ainmassupload-display": {
								"semanticObject": "ainmassupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ain.massupload",
									"url": sap.ui.require.toUrl("ain/massupload")
								}
							}
						}
					}
